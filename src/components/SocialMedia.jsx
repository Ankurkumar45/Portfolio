        ...
        <>
            <div className="social-media flex gap-4">
                <a href="https://www.linkedin.com/in/ankur-dwivedi-264209231/" target="_blank" rel="noopener noreferrer">
                    <button class="cursor-pointer w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                ...
                <a href="https://github.com/Ankurkumar45" target="_blank" rel="noopener noreferrer">
                    <button class="cursor-pointer w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500">
                        <svg class="fill-gray-900 relative z-10 transition-all duration-500 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <div class="absolute top-full left-0 w-full h-full rounded-full bg-[#171515] z-0 transition-all duration-500 group-hover:top-0"></div>
                    </button>
                </a>
                <a href="https://www.instagram.com/ur_ankur/?hl=en" target="_blank" rel="noopener noreferrer">
                    <button class="cursor-pointer w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500">
                ...
                <a href="https://www.facebook.com/profile.php?id=100013053016778" target="_blank" rel="noopener noreferrer">
                    <button class="cursor-pointer w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                ...
                <a href="https://x.com/The_Rohitian" target="_blank" rel="noopener noreferrer">
                    <button class="cursor-pointer w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                ...
                <a href="mailto:ankurkumardwivedi779@gmail.com" target="_blank" rel="noopener noreferrer">
                    <button class="cursor-pointer w-10 h-10 flex relative overflow-hidden items-center justify-center rounded-full bg-white shadow-md bg-opacity-0 shadow-gray-200 group transition-all duration-500">
